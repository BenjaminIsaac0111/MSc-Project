...
class ResultLoader:
    def __init__(self, config=None, random_seed=None):
        ...
        self.PREDICTIVE_CONFIDENCE_SAMPLE = None
    ...
    def load_patch(self, idx):
        file = os.path.split(self.get_patch_sample_names()[idx])[-1]
    ...
    def build_confidence_model(self, **kwargs):
        ...
        nn_distances, nn_ids = self.NN_LOOKUP.kneighbors(self.get_centroid_embeddings_samples())
        ...
        self.PREDICTIVE_CONFIDENCE_SAMPLE = df
    ...
    def calculate_local_entropy(self, nn_ids):
        ...
        unique_classes = list(self.CLASSES.keys())
    ...
    def regression_analysis(self, verbose=True, class_weight='unbalanced'):
        ...
        self.CONFIDENCE_MODEL = clf.fit(self.PREDICTIVE_CONFIDENCE_SAMPLE, bool(self.CORRECTNESS_MASK))
        clf_score = clf.score(self.PREDICTIVE_CONFIDENCE_SAMPLE, bool(self.CORRECTNESS_MASK))
        if verbose:
